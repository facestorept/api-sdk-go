 ...
 * @param ctx context.Context Authentication Context 
 ...
 @return []Customer*/
func (a *CustomersApiService) GetCustomerById(ctx context.Context, id int64, localVarOptionals map[string]interface{}) ([]Customer,  *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody interface{}
		localVarFileName string
		localVarFileBytes []byte
	 	successPayload  []Customer
	)
 ...
 * @param ctx context.Context Authentication Context 
 ...
 @return []Customer*/
func (a *CustomersApiService) GetCustomers(ctx context.Context, localVarOptionals map[string]interface{}) ([]Customer,  *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody interface{}
		localVarFileName string
