...
func (a *PaymentsApiService) GetPaymentById(ctx context.Context, id int64) (InlineResponse2005,  *http.Response, error) {
	var (
...
func (a *PaymentsApiService) GetPayments(ctx context.Context, localVarOptionals map[string]interface{}) (InlineResponse2004,  *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody interface{}
		localVarFileName string
